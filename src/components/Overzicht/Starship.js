...
const Starship = (props) => (
    <div class="info">
        ...
        <pre>
            ...
            {props.url.length === 33 ? <p>Detail: <a href={"/starshipDetail/" + props.url.substring(props.url.length - 2)}>{props.name} </a> </p> : <p>Details: <a href={"/starshipDetail/" + props.url.substring(props.url.length - 3)}>{props.name} </a> </p>}
