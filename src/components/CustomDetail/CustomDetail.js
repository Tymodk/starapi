...
export default class planetDetail extends React.Component {
    ...
    return isError;
       ...
       onSubmit(e) {
        ...
        if(!err){
        starService.updateCustomPlanet(this.props.match.params.id, this.state.planet).then(() => this.props.history.push('/'));
    ...
    deathstarPlanet(id) {
        starService.deathstar(id).then(() => this.props.history.push('/'));
    }

    // React lifecycle event
    // https://reactjs.org/docs/react-component.html#the-component-lifecycle
    componentWillMount() {
        starService.getCustomPlanet(this.props.match.params.id).then(response => this.setState({ planet: response }));
    }
        ...
        return (
            <section>
                ...
                <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="pill" href="#three"> Edit: {this.state.planet.name}</a></li> 
                </ul>
                 ...
                 <div id="two" class="tab-pane fade in active">      
                    ...
                    {this.state.planet.name === '' ? (<div className="loadzone"><div className="ship-container"><img src={xwing} alt="xwing ship" className="ship"/></div><img src={woosh1} alt="woosh symbol 1" className="woosh1"/><img src={woosh2} alt="woosh symbol 2" className="woosh2"/></div>) : 
                       <div class="info">
                            ...
                            <pre>
                                <p>Description: </p><p>{this.state.planet.description}</p>
                                ...
                                <p>Created at: {this.state.planet.Created_date}</p>
                     ...
                     <div id="three" class="tab-pane fade">
                         <ul className="Planet">
                            ...
                            <form>                              
                                ...
                                <RaisedButton label="Submit" onClick={e => this.onSubmit(e)} primary /><br /><br /><br />
                                <RaisedButton label="Delete" onClick={() => this.deathstarPlanet(this.state.planet._id)} primary />
                            </form>
                    </MuiThemeProvider> 
                    </pre>
                    </div>
